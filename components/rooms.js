class Rooms extends HTMLElement {
    ...
    connectedCallback() {
        ...
        <div class="row room-pics">
            <div class="column">
                <img src="https://github.com/Star-Cat13/3BM/blob/main/public/room05-400x284.jpg?raw=true" onclick="openModal(); currentSlide(1);" class="hover-shadow" />
            </div>
            <div class="column">
        ...
        <img src="https://github.com/Star-Cat13/3BM/blob/main/public/room02-400x284.jpg?raw=true" onclick="openModal(); currentSlide(4);" class="hover-shadow" />
            ...
            <div class="column">
                <img class="demo" src="https://github.com/Star-Cat13/3BM/blob/main/public/room05-400x284.jpg?raw=true" onclick="currentSlide(1);" alt="" />
            </div>
            <div class="column">
