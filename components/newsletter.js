...
<div class="sib-form newsletter-signup" style="text-align: center;">
  <div id="sib-form-container" class="sib-form-container">
    ...
    <div></div>
    <div id="sib-container" class="sib-container--large sib-container--vertical sib-form-green" style="text-align:center; background-color:#3d5637; max-width:540px; border-radius:3px; border:none; direction:ltr">
      <form id="sib-form" method="POST" action="https://a96b1965.sibforms.com/serve/MUIFAMYFT2BOPoXVcQ7K-I-u1TFSPcoUCWo11txlco8KDPu2zjC34zbr1vEAuGsZQkYh9GGHTm9wZT5euAc3oXNlbeXj9XP_FFsGGzx75x7EIk5FByy5ZbdSK1x6aPXuFjKzyv1t0oW7mWFTLHrPULBrSDTtzGLVvbwcmjwogH72zQEO_iCsSJdHfWHAQI6ZegbHkS0hhZu_U6oa6g==" data-type="subscription">
        ...
        <div style="padding: 8px 0;">
          <div class="sib-input sib-form-block">
            <div class="form__entry entry_block">
              ...
              <label class="entry__specification" style="font-size:12px; text-align:left; font-family:Helvetica, sans-serif; color:rgba(255,255,255,0.9); text-align:left">Provide your email address to subscribe. For e.g abc@xyz.com</label>
            </div>
          </div>
        </div>
        <div style="padding: 8px 0;">
        ...
        <div style="padding: 8px 0;">
          <div class="sib-form-block" style="text-align: left">
            <button class="sib-form-block__button sib-form-block__button-with-loader" style="font-size:16px; text-align:left; font-weight:700; font-family:Helvetica, sans-serif; color:#FFFFFF; background-color:#1d2528; border-radius:3px; border-width:0px;" form="sib-form" type="submit">
    ...
    _initBrevo() {
        // Brevo config (must run before main.js)
        ...
        window.EMAIL_INVALID_MESSAGE = window.SMS_INVALID_MESSAGE = window.EMAIL_INVALID_MESSAGE || "The information provided is invalid. Please review the field format and try again.";
